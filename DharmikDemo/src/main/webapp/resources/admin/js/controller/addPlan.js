app.controller('PlanCtrl', function($scope, $http, $window, $filter,
		$location, $timeout) {
	...
	$scope.addBatch = function(){
		...
		if (!$scope.BatchName) {			
			...
			var link = baseUrl+'addUser?batchName='+$scope.BatchName+'&startTime='+$scope.BatchStartTime+'&endTime='+$scope.BatchEndTime+'&description='+$scope.description;	
