...
! function (e, t, n) {
    ...
    function o() {
        ...
        for (var u in c)
            if (c.hasOwnProperty(u)) {
                ...
                for (o = r(t.fn, "function") ? t.fn() : t.fn, a = 0; a < e.length; a++) i = e[a], l = i.split("."), 1 === l.length ? Modernizr[l[0]] = o : (!Modernizr[l[0]] || Modernizr[l[0]] instanceof Boolean || (Modernizr[l[0]] = new Boolean(Modernizr[l[0]])), Modernizr[l[0]][l[1]] = o), s.push((o ? "" : "no-") + l.join("-"))
            }
    }
    ...
    l.hasEvent = d, Modernizr.addTest("hashchange", function () {
        return d("hashchange", e) === !1 ? !1 : t.documentMode === n || t.documentMode > 7
    });
    f || ! function (e, t) {
        function n(e, t) {
        ...
        function o(e, t) {
            var n = T.elements;
            "string" != typeof n && (n = n.join(" ")), "string" != typeof e && (e = e.join(" ")), T.elements = n + " " + e, l(t)
        }

        function a(e) {
            var t = N[e[S]];
            return t || (t = {}, x++, e[S] = x, N[x] = t), t
        }
        ...
        function l(e) {
            e || (e = t);
            var r = a(e);
            return !T.shivCSS || p || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), v || c(e, r), e
        }
        ...
        function d(e) {
            for (var t, n = e.split("{"), o = n.length, a = RegExp("(^|[\\s,>+~])(" + r().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), i = "$1" + C + "\\:$2"; o--;) t = n[o] = n[o].split("}"), t[t.length - 1] = t[t.length - 1].replace(a, i), n[o] = t.join("}");
            return n.join("{")
        }
        ...
        function h(e) {
            ...
            var r, o, i = a(e),
                s = e.namespaces,
                c = e.parentWindow;
            return !_ || e.printShived ? e : ("undefined" == typeof s[C] && s.add(C), c.attachEvent("onbeforeprint", function () {
                t();
                for (var a, i, s, c = e.styleSheets, l = [], f = c.length, m = Array(f); f--;) m[f] = c[f];
                for (; s = m.pop();)
    ...
    }("undefined" != typeof e ? e : this, t), o(), a(s), delete l.addTest, delete l.addAsyncTest;
...
var site = (function () {
    ...
    var themeChanger = function () {
        ...
        var updateTheme = function (thisTheme) {
            $('html').removeClass('theme--black theme--black');
    ...
    var linkHandler = function (e) {
        ...
        */
        ...
        if (url.indexOf(thishost) === 0) {
            ...
            e.preventDefault();
            var win = window.open(href, '_parent');
            win.focus();
        }
