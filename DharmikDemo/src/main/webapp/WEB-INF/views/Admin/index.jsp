...
<title>Login | Presidency Club</title>
...
<body class="bg-gradient-login" ng-app="prc" ng-controller="adminLoginCtrl">
								...
								<div class="col-lg-6">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Presidency Club</h1>
										</div>
